...
void FConcertFrontendStyle::Initialize()
{
	...
	// 32x32
	StyleSet->Set("Concert.MyLock", new IMAGE_PLUGIN_BRUSH("Icons/icon_ConcertMyLock_32x", Icon32x32));
	StyleSet->Set("Concert.OtherLock", new IMAGE_PLUGIN_BRUSH("Icons/icon_ConcertOtherLock_32x", Icon32x32));
