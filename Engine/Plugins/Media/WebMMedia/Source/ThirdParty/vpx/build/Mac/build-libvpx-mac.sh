...
./configure --disable-examples --disable-unit-tests --extra-cflags="-fvisibility=hidden -mmacosx-version-min=10.12" > $DEST_DIR/build.log
echo "# Building $VER"
...
./configure --enable-pic --enable-static --disable-examples --disable-unit-tests --extra-cflags="-fvisibility=hidden -mmacosx-version-min=10.12" > $DEST_DIR/build-pic.log
