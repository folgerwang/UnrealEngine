...
/**
 * Implements a details view customization for the FAjaMediaPort
 */
class FAjaMediaPortCustomization : public IPropertyTypeCustomization
{
public:
	static TSharedRef<IPropertyTypeCustomization> MakeInstance()
	{
		return MakeShareable(new FAjaMediaPortCustomization);
	}
