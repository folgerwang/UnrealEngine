 ...
 */
class FMeshEditorMode : public FEdMode
{
public:
...
public:
	...
	EEditableMeshElementType GetMeshElementSelectionMode() const 
	{ 
		return MeshElementSelectionMode; 
	}
	
	/** Sets the mesh element selection mode to use */
	void SetMeshElementSelectionMode( EEditableMeshElementType ElementType );
