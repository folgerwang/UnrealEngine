...
void UMeshDescription::RegisterBaseAttributes()
{
	...
	PolygonGroupAttributes().RegisterAttribute<FSoftObjectPath>(MeshAttribute::PolygonGroup::MaterialAsset); //Deprecated
	...
	PolygonGroupAttributes().RegisterAttribute<int>(MeshAttribute::PolygonGroup::MaterialIndex); //This attribute is used for FRawMesh conversion only and is temporary, use the ImportedMaterialSlotName to match the mesh material slot
}
...
void UMeshDescription::UnRegisterBaseAttributes()
{
	...
	PolygonGroupAttributes().UnregisterAttribute<FSoftObjectPath>(MeshAttribute::PolygonGroup::MaterialAsset);
