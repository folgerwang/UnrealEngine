...
#define UI_COMMAND_EXT( BindingContext, OutUICommandInfo, CommandIdName, FriendlyName, InDescription, CommandType, InDefaultChord ) \
	UI_COMMAND_Function( BindingContext, OutUICommandInfo, TEXT(LOCTEXT_NAMESPACE), TEXT(CommandIdName), TEXT(CommandIdName) TEXT("_ToolTip"), "." CommandIdName, TEXT(FriendlyName), TEXT(InDescription), CommandType, InDefaultChord );
#define UI_COMMAND( CommandId, FriendlyName, InDescription, CommandType, InDefaultChord ) \
	UI_COMMAND_EXT( this, CommandId, #CommandId, FriendlyName, InDescription, CommandType, InDefaultChord )
