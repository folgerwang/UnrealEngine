	...
	: public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, meta=(DisplayName="NotEqual (Guid)", CompactNodeTitle="!=", BlueprintThreadSafe), Category="Guid")
	static bool NotEqual_GuidGuid( const FGuid& A, const FGuid& B );

	/** Checks whether the given GUID is valid */
	UFUNCTION(BlueprintPure, meta=(DisplayName="IsValid (Guid)", CompactNodeTitle="isValid?", BlueprintThreadSafe), Category="Guid")
	static bool IsValid_Guid( const FGuid& InGuid );

	/** Invalidates the given GUID */
	UFUNCTION(BlueprintCallable, meta=(DisplayName="Invalidate_Guid (Guid)", BlueprintThreadSafe), Category="Guid")
	...
	UFUNCTION(BlueprintPure, meta=(DisplayName="ToString (Guid)", CompactNodeTitle="->", ScriptMethod="ToString", BlueprintThreadSafe), Category="Guid")
