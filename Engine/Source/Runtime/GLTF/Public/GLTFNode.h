...
namespace GLTF
{
	...
	struct GLTF_API FSkinInfo
	{
		...
		FSkinInfo(const FAccessor& InInverseBindMatrices)
		    : InverseBindMatrices(InInverseBindMatrices)
		    , Skeleton(INDEX_NONE)
		{
		}
	};
