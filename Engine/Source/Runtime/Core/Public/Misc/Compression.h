...
struct FCompression
{
	...
	DEPRECATED(4.20, "Use the FName based version of CompressMemoryBound")
	...
	DEPRECATED(4.20, "Use the FName based version of CompressMemory")
	...
	DEPRECATED(4.20, "Use the FName based version of UncompressMemory")
