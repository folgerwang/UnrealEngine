...
class GPG_EXPORT QuestManager {
 public:
   ...
   * <code>Fetch(DataSource data_source, const std::string& quest_id, </code>
   ...
   * <code>Timeout timeout, const std::string& quest_id)</code>,
   ...
   * <code>FetchResponse FetchBlocking(DataSource data_source, </code>
   * <code>Timeout timeout, const std::string& quest_id)</code>, with
   ...
   * @ingroup Callbacks
   */
  typedef std::function<void(const FetchListResponse &)> FetchListCallback;
   ...
   * @ingroup Callbacks
   */
  typedef std::function<void(const AcceptResponse &)> AcceptCallback;
   ...
   * <code>const std::string& quest_id)</code>, with <code>timeout</code>
   ...
   * @ingroup Callbacks
   */
  typedef std::function<void(const ClaimMilestoneResponse &)>
   ...
   */
  void ClaimMilestone(const QuestMilestone &milestone,
  ...
  ClaimMilestoneResponse ClaimMilestoneBlocking(
      const QuestMilestone &milestone);
   ...
   */
  ClaimMilestoneResponse ClaimMilestoneBlocking(
      Timeout timeout, const QuestMilestone &milestone);
   ...
   * @ingroup Callbacks
   */
  typedef std::function<void(const QuestUIResponse &)> QuestUICallback;
   ...
   * It synchronously returns a <code>QuestUIResponse</code>.
   * Not specifying <code>timeout</code> makes this function call equivalent
   * to calling <code>ShowUIBlocking(Timeout timeout, const Quest& quest)</code>
   * with <code>timeout</code> specified as 10 years.
   */
