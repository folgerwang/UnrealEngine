...
class GPG_EXPORT RealTimeRoom {
 public:
   ...
   */
  explicit RealTimeRoom(std::shared_ptr<const RealTimeRoomImpl> impl);
   ...
   * data.
   *
   * Must return true for the getter functions on the <code>RealTimeRoom</code>
   * object (<code>Id</code>, <code>CreationTime</code>, etc...) to be usable.
   */
  bool Valid() const;
 ...
 private:
  ...
  std::shared_ptr<const RealTimeRoomImpl> impl_;
};
