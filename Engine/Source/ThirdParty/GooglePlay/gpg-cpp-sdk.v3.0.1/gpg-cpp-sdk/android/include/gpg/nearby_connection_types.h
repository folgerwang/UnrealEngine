...
typedef std::function<void(int64_t client_id,
                           const StartAdvertisingResult &result)>
    StartAdvertisingCallback;

/**
 * Defines a callback type that receives a {@link ConnectionResponse} when a
 * response arrives after an attempt to establish a connection to a remote
 * endpoint. <code>client_id</code> is the ID of the
 * <code>NearbyConnections</code> instance that sent the connection request.
