...
std::string DebugString(const Achievement &achievement) GPG_EXPORT;
...
std::ostream &operator<<(std::ostream &os,
                         const Achievement &achievement) GPG_EXPORT;
...
std::string DebugString(const Event &event) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os, const Event &event) GPG_EXPORT;
...
std::string DebugString(const Leaderboard &leaderboard) GPG_EXPORT;
...
std::string DebugString(const Score &score) GPG_EXPORT;

/// Returns all score-page data in human-readable form.
std::string DebugString(const ScorePage &score_page) GPG_EXPORT;

/// Returns all score entries in human-readable form.
std::string DebugString(const ScorePage::Entry &entry) GPG_EXPORT;

/// Returns all score summary data in human-readable form.
std::string DebugString(const ScoreSummary &summary) GPG_EXPORT;
...
/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const Leaderboard &leaderboard) GPG_EXPORT;
...
/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os, const Score &score) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const ScorePage &score_page) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const ScorePage::Entry &entry) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const ScoreSummary &summary) GPG_EXPORT;
...
std::string DebugString(const TurnBasedMatch &match) GPG_EXPORT;

/// Returns data for a multiplayer invitation in human-readable form.
std::string DebugString(const MultiplayerInvitation &invitation) GPG_EXPORT;

/// Returns data for a turn-based match configuration object in human-readable
/// form.
std::string DebugString(const TurnBasedMatchConfig &config) GPG_EXPORT;

/// Returns a multiplayer participant in human-readable form.
std::string DebugString(const MultiplayerParticipant &participant) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const TurnBasedMatch &match) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const MultiplayerInvitation &invitation) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const TurnBasedMatchConfig &config) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const MultiplayerParticipant &participant) GPG_EXPORT;
...
std::string DebugString(const Player &player) GPG_EXPORT;

/// Returns player level info in human-readable form.
std::string DebugString(const PlayerLevel &player) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os, const Player &player) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const PlayerLevel &player) GPG_EXPORT;
...
std::string DebugString(const QuestState &quest_state) GPG_EXPORT;

/// Returns a human-readable milestone state.
std::string DebugString(const QuestMilestoneState &milestone_state) GPG_EXPORT;

/// Returns all quest data in human-readable form.
std::string DebugString(const Quest &quest) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const QuestState &quest_state) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const QuestMilestoneState &milestone_state) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os, const Quest &quest) GPG_EXPORT;
...
std::string DebugString(const SnapshotMetadata &metadata) GPG_EXPORT;

/// Returns data from a snapshot metadata change in human-readable form.
std::string DebugString(const SnapshotMetadataChange &change) GPG_EXPORT;
...
/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const SnapshotMetadata &metadata) GPG_EXPORT;

/// Provided for easy use of the corresponding debug string with streams.
std::ostream &operator<<(std::ostream &os,
                         const SnapshotMetadataChange &change) GPG_EXPORT;
