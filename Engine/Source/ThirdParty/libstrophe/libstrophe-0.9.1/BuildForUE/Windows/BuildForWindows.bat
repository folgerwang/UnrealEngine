...
cd "%VS2015_X86_PATH%"
cmake -G "Visual Studio 14 2015" -DCMAKE_SUPPRESS_REGENERATION=1 -DSOCKET_IMPL=../../../src/sock.c -DOPENSSL_PATH=../../../OpenSSL/1.0.2g/include/Win32/VS2015 -DDISABLE_TLS=0 %PATH_TO_CMAKE_FILE%
...
cd "%VS2015_X64_PATH%"
cmake -G "Visual Studio 14 2015 Win64" -DCMAKE_SUPPRESS_REGENERATION=1 -DSOCKET_IMPL=../../../src/sock.c -DOPENSSL_PATH=../../../OpenSSL/1.0.2g/include/Win64/VS2015 -DDISABLE_TLS=0 %PATH_TO_CMAKE_FILE%
