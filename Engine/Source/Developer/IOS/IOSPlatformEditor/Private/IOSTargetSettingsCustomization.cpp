	...
	, GameGraphicsPath(FString::Printf(TEXT("%sBuild/IOS/Resources/Graphics"), *FPaths::ProjectDir()))
{
    ...
    new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPhone6Plus-Landscape.png"), LOCTEXT("LaunchImage_iPhone6Plus_Landscape", "iPhone 6+/7+/8+/9 in Landscape"), FText::GetEmpty(), 2208, 1242, FPlatformIconInfo::Required);
    new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPhone6Plus-Portrait.png"), LOCTEXT("LaunchImage_iPhone6Plus_Portrait", "iPhone 6+/7+/8+/9 in Portrait"), FText::GetEmpty(), 1242, 2208, FPlatformIconInfo::Required);
	...
	new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPhoneXSMax-Portrait.png"), LOCTEXT("LaunchImage_iPhoneXMax_Portrait", "iPhone XS Max in Portrait"), FText::GetEmpty(), 1242, 2688, FPlatformIconInfo::Required);
	new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPhoneXR-Landscape.png"), LOCTEXT("LaunchImage_iPhoneXR_Landscape", "iPhone XR in Landscape"), FText::GetEmpty(), 1792, 828, FPlatformIconInfo::Required);
	new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPhoneXR-Portrait.png"), LOCTEXT("LaunchImage_iPhoneXR_Portrait", "iPhone XR in Portrait"), FText::GetEmpty(), 828, 1792, FPlatformIconInfo::Required);
	...
	new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPadPro10_5_Landscape.png"), LOCTEXT("LaunchImage_iPadPro_Landscape", "iPad Pro 10.5 in Landscape"), FText::GetEmpty(), 2224, 1668, FPlatformIconInfo::Required);
	new (LaunchImageNames) FPlatformIconInfo(TEXT("Default-IPadPro10_5_Portrait.png"), LOCTEXT("LaunchImage_iPadPro_Portrait", "iPad Pro 10.5 in Portrait"), FText::GetEmpty(), 1668, 2224, FPlatformIconInfo::Required);
