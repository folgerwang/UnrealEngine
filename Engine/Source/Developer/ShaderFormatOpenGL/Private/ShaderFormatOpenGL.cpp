...
class FShaderFormatGLSL : public IShaderFormat
{
	enum
	{
		...
		UE_SHADER_GLSL_150_VER = 76,
		UE_SHADER_GLSL_430_VER = 76,
		UE_SHADER_GLSL_ES2_VER = 76,
		UE_SHADER_GLSL_150ES2_VER = 76,
		UE_SHADER_GLSL_150ES2NOUB_VER = 76,
		UE_SHADER_GLSL_150ES3_1_VER = 76,
		UE_SHADER_GLSL_ES2_VER_WEBGL = 76,
		UE_SHADER_GLSL_ES2_IOS_VER = 76,
		UE_SHADER_GLSL_310_ES_EXT_VER = 76,
		UE_SHADER_GLSL_ES3_1_ANDROID_VER = 76,
	}; 
