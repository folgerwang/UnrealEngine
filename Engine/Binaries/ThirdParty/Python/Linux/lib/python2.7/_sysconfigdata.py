...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--enable-optimizations' 'CPPFLAGS=-fPIC'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'COVERAGE_INFO': '/tmp/scratch/20863/Python-2.7.14/coverage.info',
 'COVERAGE_REPORT': '/tmp/scratch/20863/Python-2.7.14/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov report"',
 'CPPFLAGS': '-I. -IInclude -I./Include -fPIC',
 'CXX': 'g++ -pthread',
 'C_THREADS': 0,
 ...
 'abs_builddir': '/tmp/scratch/20863/Python-2.7.14',
 'abs_srcdir': '/tmp/scratch/20863/Python-2.7.14',
